...
const mockOrders = [
  ...
  },
  {
    ...
    products: [{ name: "Product 2", quantity: 1, price: 25.50 }],
    total: 25.50,
...
const mockProducts = [
  {
    ...
    price: 10.99,
    variants: [
      { id: "variant-1", value: "Red", type: "COLOR" as const, variantPrice: 12.99 },
    ],
  },
  {
    id: "product-2",
...
describe("OrdersPage", () => {
  ...
  describe("Rendering", () => {
    it("renders the page with orders data", () => {
      ...
      expect(screen.getByText("Manage customer orders and track fulfillment")).toBeInTheDocument()
  ...
  describe("Order Deletion", () => {
    ...
    it("renders delete confirmation dialog", () => {
      ...
      expect(screen.getByText(/Are you sure you want to delete order order-1/)).toBeInTheDocument()
    })
  ...
  describe("Form Validation and UX", () => {
    ...
    it("displays product list in form", () => {
      ...
      expect(screen.getByText(/Product 1 \(Red\) × 2 — \$21.98/)).toBeInTheDocument()
